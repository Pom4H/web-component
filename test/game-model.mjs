...
assert.ok(app.publicEvents.some(event => event.name === 'game-command' && event.source === 'visualizer-hud'))
assert.ok(app.publicEvents.some(event => event.name === 'dialogue-choice' && event.source === 'visualizer-dialogue'))
