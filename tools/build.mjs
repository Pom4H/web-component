...
const internalNames = {
  ...
  unwrap:'uw', raw:'rw', toText:'tx', owns:'ow', read:'rd', follow:'fl', exact:'ex', AsyncFunction:'AF', scriptCache:'SC', bootstrap:'bs', ITERATE:'_i', MISS:'_m', DYNAMIC:'_d', INITIAL:'_n', TEXT:'_0', ATTR:'_1', BOOL:'_2', PROP:'_3', EVENT:'_4', LIST:'_5', BRANCH:'_6', CSS_VAR:'_7', clearDependencies:'cd', compilePath:'cp', loadElement:'le', defineSkeinElement:'de', registerComponent:'dc', parseTokens:'pt', moveNodesBefore:'mv', keyFromItem:'ki', bindText:'bt', bindAttribute:'ba', bindBoolean:'bb', bindProperty:'bp', bindCustomProperty:'bc', bindEvent:'be', byPath:'np', watch:'ww', render:'rn', reactiveTarget:'rt', reactive:'rx', dep:'dp',
