...
const internalNames = {
  ...
  unwrap:'uw', toText:'tx', owns:'ow', read:'rd', follow:'fl', exact:'ex', AsyncFunction:'AF', scriptCache:'SC', bootstrap:'bs', REF:'_r', ITERATE:'_i', MISS:'_m', DYNAMIC:'_d', INITIAL:'_n', TEXT:'_0', ATTR:'_1', BOOL:'_2', PROP:'_3', EVENT:'_4', LIST:'_5', BRANCH:'_6', clearDependencies:'cd', compilePath:'cp', defineElement:'de', registerComponent:'dc', parseTokens:'pt', moveNodesBefore:'mv', keyFromItem:'ki', bindText:'bt', bindAttribute:'ba', bindBoolean:'bb', bindProperty:'bp', bindEvent:'be', byPath:'np', watch:'ww', render:'rn',
  activeObserver:'$a', subscribers:'$b', dependencies:'$c', renderQueue:'$d', effectQueue:'$e', pending:'$f', flushing:'$g', callback:'$h', current:'$i', dirty:'$j', disposed:'$k', cached:'$l', scope:'$m', children:'$n', owned:'$o', cleanups:'$p', paused:'$q', controller:'$r', parent:'$s', rootState:'$t', contextRef:'$u', contextValue:'$43', locals:'$v', contexts:'$w', contextChain:'$x', bindingScope:'$y', owner:'$z', instruction:'$A', records:'$B', order:'$C', expression:'$D', keyPath:'$E', view:'$G', visible:'$H', fragment:'$I', elements:'$J', instructions:'$K', customPaths:'$L', scripts:'$M', cache:'$O', parser:'$P', mounting:'$R', generation:'$S', instances:'$T', previous:'$U', structural:'$V', previousLength:'$W', target:'$X', receiver:'$Y', property:'$Z', proxy:'$_a', tokenList:'$_b', childContexts:'$_c', pathExpression:'$_d', templateNode:'$_e', indexRef:'$_f', itemScope:'$_g', exactPath:'$_h',
  value:'b', node:'c', path:'d', index:'e', name:'f', child:'h', nodes:'i', type:'j', element:'k', existing:'l', record:'m', anchor:'n', end:'o', key:'p', raw:'q', dep:'r', result:'s', computed:'t', effect:'u', onCleanup:'v', abortSignal:'w', host:'x', input:'$49', inputs:'$50', acceptInput:'$51', start:'y', head:'z', source:'A', tag:'J', item:'L', occurrence:'M', response:'N', event:'P', lookup:'aa', context:'ab', tokens:'ac', component:'ad', promise:'ae', hit:'af', last:'ah', active:'ai', cleanup:'aj', notify:'ak', track:'$0', invalidate:'$1', run:'$2', request:'$3', flush:'$4', compute:'$5', find:'$6', reactive:'$7', reload:'$9', mount:'$10', runScript:'$11', report:'$12', compileChildren:'$13', instantiate:'$14', fromNode:'$15', update:'$16', pause:'$17', resume:'$18', own:'$20', setContext:'$21', register:'$22', load:'$23', compile:'$24', signal:'$25', collection:'$26', script:'$27', template:'$F', observer:'$28', parts:'$29', token:'$30', next:'$31', occurrences:'$32', deps:'$33', proxies:'$34', enqueue:'$35', root:'$36', items:'$37', handler:'$38', forPath:'$39', ifPath:'$40', inPath:'$41', parentPath:'$42', subscriber:'$44', mutable:'$45', contextPath:'$46', listener:'$47', baseURL:'$48'
};
